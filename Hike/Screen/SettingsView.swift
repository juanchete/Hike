    ...
    var body: some View {
        List {
            ...
            Section(header: Text("Alternate Icons")) {
                ...
                Text("Choose your favourite app cion from the collection above.")
            ...
            Section(
                ...
                CustomListView(rowLabel: "Designer", rowIcon: "paintpallete", rowContent: "Juan Lopez", rowTintColor: .pink)
               CustomListView(rowLabel: "Website", rowIcon: "globe", rowTintColor: .indigo, rowLinkLabel: "Credo Academy", rowLinkDestination: "https://credo.academy")
            } //: SECTION
        }
